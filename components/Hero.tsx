    ...
    <section className="relative min-h-screen flex items-center justify-center pt-28 pb-12 overflow-hidden bg-[#050505]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
        ...
        >
          ...
          {/* Mobile walata font size 4xl, tablet walata 5xl, desktop walata 7xl */}
        ...
        >
          ...
          <div className="relative w-[280px] sm:w-[320px] md:w-[400px] aspect-[2/3] rounded-r-2xl shadow-2xl shadow-blue-900/50 transform transition-transform hover:scale-105 duration-500 group">
             ...
             {/* Floating Badge */}
             <div className="absolute -bottom-6 -right-6 bg-black border border-gray-700 p-3 sm:p-4 rounded-xl shadow-xl flex items-center gap-3">
