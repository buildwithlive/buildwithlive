            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <div className="lg:w-1/2 w-full order-2 lg:order-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            {['Biceps (22 Exercises)', 'Triceps (26 Exercises)', 'Forearms', 'Shoulders (40 Exercises)', 'Chest (35 Exercises)', 'Back & Lats', 'Quadriceps', 'Hamstrings', 'Glutes', 'Abs'].map((item, i) => (
                                <div key={i} className="flex items-center gap-3 text-gray-300 bg-gray-900/30 p-3 rounded-xl lg:bg-transparent lg:p-0 border border-white/5 lg:border-none">
                    ...
                    <div className="lg:w-1/2 w-full relative order-1 lg:order-2">
                        <div className="bg-gradient-to-br from-gray-800 to-black p-6 md:p-8 rounded-3xl border border-white/10 relative overflow-hidden shadow-2xl">
                            <div className="absolute top-0 right-0 p-3 bg-red-600 rounded-bl-2xl text-white font-bold text-[10px] sm:text-xs uppercase z-10 tracking-widest">
                                Exclusive Content
                            </div>
                            <div className="space-y-4 opacity-50 hover:opacity-100 transition-opacity duration-500">
                                <div className="h-4 bg-gray-700 rounded w-3/4 animate-pulse"></div>
                                <div className="h-32 sm:h-48 bg-gray-700/50 rounded-xl flex items-center justify-center border-2 border-dashed border-gray-600">
                                    <div className="text-center p-4">
                                        <Play className="mx-auto text-gray-500 mb-2 w-8 h-8" />
                                        <p className="text-gray-500 text-xs sm:text-sm">Scan QR to Watch Video</p>
                                    </div>
                                </div>
